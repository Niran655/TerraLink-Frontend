  ...
  const Content = useRoutes([
    {
      ...
      children: [
        ...
        { path: '/setting/shift-management', element: <Guard module="hr"><ShiftManagement /></Guard> },
        { path: '/setting/leave-management', element: <Guard module="hr"><LeaveManagement /></Guard> },
