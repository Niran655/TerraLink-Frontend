      ...
      <Grid container spacing={3} mt={2}>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          <Paper
            className="setting-box"
            component={RouterLink}
            to="/setting/security-center"
            sx={{ cursor: "pointer", textDecoration: "none" }}
          >
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", width: 48, height: 48, borderRadius: "50%", bgcolor: "rgba(46, 125, 50, 0.1)", color: "#2E7D32", mb: 1 }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            </Box>
            <Stack textAlign="start" spacing={1}>
              <Typography className="text-title" variant="h5">
                {t(`security_center`) || "Security Center"}
              </Typography>
              <Typography className="text-body">
                {t(`manage_data_privacy`) || "Manage data ownership, privacy, & AI access"}
              </Typography>
            </Stack>
          </Paper>
        </Grid>
