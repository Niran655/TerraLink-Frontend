...
export default function ViewProductTransfer({
  ...
  const totalAmount = items.reduce(
    (s, i) => s + i.quantity * (i.costPrice || i.subProduct?.costPrice || 0),
    0
  );
      ...
      <Box sx={{ height: "100vh", p: 2 }}>
        ...
        >
          ...
          >
            ...
            <InfoRow
              label={t("accepted_by")}
              value={acceptedBy?.nameEn || acceptedBy?.nameKh}
            />
            <InfoRow
              label={t("create_at")}
            ...
            >
              ...
              <Stack direction="row" justifyContent="space-between" mt={2}>
                ...
                <Box textAlign="right">
                  <Typography>
                    {t("send_by")}:{" "}
                    {language === "en" ? requestedBy?.nameEn : requestedBy?.nameKh}
                  </Typography>
                  <Typography>
                    {t("accepted_by")}:{" "}
                    {language === "en" ? acceptedBy?.nameEn : acceptedBy?.nameKh || "-"}
                  </Typography>
                </Box>
              </Stack>
              ...
              <Table>
                ...
                <TableBody>
                  {items.map((row, index) => {
                    const price = row.costPrice || row.subProduct?.costPrice || 0;
